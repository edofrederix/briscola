        ...
        forAll(field[l], d)
        {
            ...
            forAllCells(F, i, j, k)
            {
                ...
                F(ijk) =
                  ...
                  * faceScalar
                    (
                        ((f0(ijk  - ox) > 0) ? - f0(ijk  - ox)  : - f0(ijk)),
                        ((f0(ijkr - ox) > 0) ?   f0(ijkr - ox)  :   f0(ijkr)),
                        ((f1(ijk  - oy) > 0) ? - f1(ijk  - oy)  : - f1(ijk)),
                        ((f1(ijkt - oy) > 0) ?   f1(ijkt - oy)  :   f1(ijkt)),
                        ((f2(ijk  - oz) > 0) ? - f2(ijk  - oz)  : - f2(ijk)),
                        ((f2(ijkf - oz) > 0) ?   f2(ijkf - oz)  :   f2(ijkf))
                    );
            }
        }
    }
