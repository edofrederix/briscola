...
{                                                                               \
    tmp<meshField<ReturnType,MeshType>> tRes =                                  \
        reuseFieTmp<ReturnType,Type,MeshType>::New                              \
        (                                                                       \
            tf,                                                                 \
            #Func "("+tf().name()+")"                                           \
        );                                                                      \
...
{                                                                               \
    tmp<meshField<ReturnType,MeshType>> tRes =                                  \
        reuseFieTmp<ReturnType,Type,MeshType>::New(tf,#Op "("+tf().name()+")"); \
    OpFunc(tRes.ref(), tf());                                                   \
    tf.clear();                                                                 \
    return tRes;                                                                \
}
...
{                                                                               \
    tmp<meshField<ReturnType,MeshType>> tRes =                                  \
        reuseFieTmpTmp<ReturnType,Type1,Type1,Type2,MeshType>::New              \
        (                                                                       \
            tf1,                                                                \
            tf2,                                                                \
