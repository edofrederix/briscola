...
inline void diagonalSmoother<SType,Type,MeshType>::diagonalSmoother::Sweep
(
...
template<class SType, class Type, class MeshType>
void diagonalSmoother<SType,Type,MeshType>::diagonalSmoother::Smooth
(
    linearSystem<SType,Type,MeshType>& sys,
    const label l,
    const label sweeps,
...
template<class SType, class Type, class MeshType>
diagonalSmoother<SType,Type,MeshType>::diagonalSmoother
(
